...
/**
 *
 * @author Dhriti Communicates between ElevatorSubsystem and FloorSubsystem -
 *         Scheduler will reply to the Elevator when there is work to be done -
 *         After data is sent from to the elevator, it will forward the Data to
 *         the floor
 */
public class Scheduler {
	...
	public static void main(String[] args) {
		...
		// Send task info to elevatorSubsys (button press + 1 bit that determines which
		// elevator should do it
